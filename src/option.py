...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/DIV2K2017',   #'/home/dataset',
...
parser.add_argument('--data_range', type=str, default='1-800/801-805', #796-800
                    help='train/test data range')                    
#parser.add_argument('--n_train', type=int, default=800,
#                    help='number of training set')
                                        
parser.add_argument('--ext', type=str, default='sep', #bin
...
parser.add_argument('--model', default='EMRAB', #EMRAB
                    help='model name')
