...
class MRAB(nn.Module):
    ...
    def forward(self, x):        
        ...
        input_2 = torch.cat([output_3_1, output_5_1], 1) #2*n_feats
        input_2 = self.compress(input_2) #n_feats
        
        output_3_2 = self.relu(self.conv_3_2(input_2)) #n_feats  
        output_5_2 = self.relu(self.conv_5_2(input_2)) #n_feats
        input_3 = torch.cat([output_3_2, output_5_2], 1) #2*n_feats
        input_3 = self.compress(input_3) #n_feats
        
        output_3_3 = self.relu(self.conv_3_3(input_3)) #n_feats  
        output_5_3 = self.relu(self.conv_5_3(input_3)) #n_feats
        input_4 = torch.cat([output_3_3, output_5_3], 1) #2*n_feats
